...
Hᴇʀᴇ Is Tʜᴇ Hᴇʟᴘ Fᴏʀ Mʏ Cᴏᴍᴍᴀɴᴅs.</b>"""
    ...
    ABOUT_TXT = """<b>✯ Mʏ Nᴀᴍᴇ: {}
✯ Cʀᴇᴀᴛᴏʀ: <a href='https://t.me/MN_BOTZ'>MN_BOTZ</a>
✯ Lɪʙʀᴀʀʏ: <a href='https://docs.pyrogram.org/'>Pʏʀᴏɢʀᴀᴍ</a>
✯ Lᴀɴɢᴜᴀɢᴇ: <a href='https://www.python.org/download/releases/3.0/'>Pʏᴛʜᴏɴ 3</a>
✯ DᴀᴛᴀBᴀsᴇ: <a href='https://www.mongodb.com/'>MᴏɴɢᴏDB</a>
✯ Bᴏᴛ Sᴇʀᴠᴇʀ: <a href='https://studio.mogenius.com'>Mᴏɢᴇɴɪᴜs</a>
✯ Bᴜɪʟᴅ Sᴛᴀᴛᴜs: v1.0 [ Sᴛᴀʙʟᴇ ]</b>"""

    SOURCE_TXT = """<b>ɴᴏᴛᴇ:
- ᴛʜɪꜱ ʙᴏᴛ ɪꜱ ᴀɴ ᴏᴘᴇɴ ꜱᴏᴜʀᴄᴇ ᴘʀᴏᴊᴇᴄᴛ.
- ꜱᴏᴜʀᴄᴇ - <a href="https://t.me/KAMMARAN_The_File_Patron">ʜᴇʀᴇ</a>
Dᴇᴠᴇʟᴏᴘᴇʀ:
- <a href="https://t.me/Whitedeviljoypow">ᗯᕼᏆᎢᗴ ᗞᗴᐯᏆし</a></b>"""
...
<b>ᴜʀʟ ʙᴜᴛᴛᴏɴꜱ:</b>
<code>[Button Text](buttonurl:https://t.me/KAMMARAN_The_File_Patron)</code>
<b>ᴀʟᴇʀᴛ ʙᴜᴛᴛᴏɴꜱ:</b>
...
• ꜰᴜʟʟ ɴᴀᴍᴇ : ᗯᕼᏆᎢᗴ ᗞᗴᐯᏆし
• ᴜꜱᴇʀɴᴀᴍᴇ : @Whitedeviljoypow
• ᴘᴇʀᴍᴀɴᴇɴᴛ ᴅᴍ ʟɪɴᴋ : <a href='t.me/Whitedeviljoypow'>ᴄʟɪᴄᴋ ʜᴇʀᴇ</a></b>"""
...
<b>
╭─────── • ◆ • ───────╮
🔅 Special Mᴏᴅᴇ :  <a href="https://t.me/addtheme/KAMMARAN_The_File_Patron_Theme">Tᴏᴜᴄʜ</a>
╰─────── • ◆ • ───────╯

=========== • ✠ • ===========
▫️ ᴄʜᴀɴɴᴇʟ : @KAMMARAN_The_File_Patron
▫️ sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ : @KAMMARAN_The_File_Patron_Support
=========== • ✠ • ===========</b>"""
